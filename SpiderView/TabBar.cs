        ...
        public void Draw(Graphics g)
        {
            try
            {
                ...
                foreach (Tab tab in Tabs)
                {
                    ...
                    this.Block.Stylesheet.DrawString(graphics.Graphics, tab.Title, new Font("MS Sans Serif", 8), new SolidBrush(Block.TextShadowColor), new Rectangle((int)left, 4, 320, 50));
                    this.Block.Stylesheet.DrawString(graphics.Graphics, tab.Title, new Font("MS Sans Serif", 8), new SolidBrush(Block.ForeColor), new Rectangle((int)left, 3, 320, 50));
